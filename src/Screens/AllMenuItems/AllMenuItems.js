                            ...
                            <Swipeout right={[
                                ...
                                <TouchableOpacity onPress = {()=>{
                                    ...
                                    <View style={{ backgroundColor: '#fceef8', }}>
                                        ...
                                        <Text style={{ fontWeight: 'bold', fontSize: 18, margin: 10 }}> {item.userEmail}</Text>
                                        ...
                                        <Text style={{ fontSize: 18, margin: 10 }} numberOfLines={2}>Description: {item.item_description}</Text>
